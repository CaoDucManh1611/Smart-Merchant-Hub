...
DEFAULT_PLANS = (
    ...
    },
    {
        "code": "scale",
        "name": "Gói Scale",
        "description": "Gói cho shop vận hành đồng thời trên 4 nền tảng.",
        ...
        "features": {"onboarding": True, "support": "priority", "display_name": "Gói Scale", "chatbot_rental_price": 1000000},
    },
    {
        "code": "pro",
        "name": "Gói Premium",
        ...
        "max_ai_calls": 25000,
        "max_ai_cost": Decimal("1500"),
        "features": {"onboarding": True, "support": "dedicated", "display_name": "Gói Premium", "chatbot_rental_price": 1500000},
    },
)
